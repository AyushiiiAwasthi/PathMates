...
const TileTooltip = ({
  ...
  const activeBackgroundColor = unit?.backgroundColor ?? "bg-blue-500";
  const activeTextColor = unit?.textColor ?? "text-blue-500";
  ...
  return (
    ...
    >
      <header className="flex items-center justify-between gap-4 p-4">
        ...
        <Link
          href={"https://www.geeksforgeeks.org/dsa/time-complexity-and-space-complexity/"}
          className={[
