...
const lessonProblem1 = {
  ...
  answers: [
    {
      icon: <img src="/linear.png" alt="Apple" className="w-25 h-40" />,
      name: ""
    },
    {
      icon: <img src="/quad.png" alt="Boy" className="w-25 h-40" />,
      name: ""
    },
    {
      icon: <img src="/log.png" alt="Woman" className="w-25 h-40" />,
      name: ""
    },
  ],
  correctAnswer: 0,
...
const lessonProblem2 = {
  type: "THINK_AND_ANSWER",
  question: "Which sorting algorithm takes O(nlogn) complexity?",
  answerTiles: ["insertion", "quick", "radix", "bubble", "merge", "sort"],
  correctAnswer: [4, 5],
} as const;
        ...
        <section className="flex max-w-2xl grow flex-col gap-5 self-center sm:items-center sm:justify-center sm:gap-24">
          ...
          <div className="w-full">
            <div className="flex items-center gap-2 px-2">
              <Image src="/shinchan.png" alt="" width={92} height={230} />
  ...
  return (
    <div className="flex min-h-screen flex-col px-5 py-8 text-center">
      <div className="flex grow flex-col items-center justify-center gap-5">
        <img
      src="/fast.jpg" // Place the image inside your `public/` folder
      alt="Fast Forward"
      width={100}
      height={224}
...
const LessonFastForwardEndFail = ({
  ...
  return (
    <div className="flex min-h-screen flex-col px-5 py-8 text-center">
      <div className="flex grow flex-col items-center justify-center gap-5">
               <img
      src="/sad.jpg" // Place the image inside your `public/` folder
      alt="Fast Forward"
      width={100}
      height={224}
      className="w-[42px] h-[34px]" // Optional Tailwind styling
    />
...
const LessonFastForwardEndPass = ({
  ...
  return (
    <div className="flex min-h-screen flex-col px-5 py-8 text-center">
      <div className="flex grow flex-col items-center justify-center gap-5">
                <img
      src="/happy.jpg" // Place the image inside your `public/` folder
      alt="Fast Forward"
      width={100}
      height={224}
      // Optional Tailwind styling
